    ...
    <div class="contenedor">
        <header>
            ...
            <div class="logo">
                ...
                while($filas=mysqli_fetch_array($res)){
                    ...
                    elseif($filas['contenido'] == 'Desarrolladores web junior'){
        ...
        <footer class="contenedor">
            ...
            <div class="creado-por">
                <p>Sitio diseñado por <a href="nosotros.php">Grupo 1</a> - <a href="nosotros.php">Desarrollo Web</a> - <a href="nosotros.php">Nosotros</a></a></p>
            </div>
        </footer>
    </div>
